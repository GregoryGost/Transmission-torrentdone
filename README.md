...
- v3.1.0 - (22.09.2024) - Поправлено получение имени сериала. Ихменен regex для обработки сериалов LostFilm. Изменился
  формат. Пример `The Penguin S01E01.1080p.rus.LostFilm.TV.mkv`
